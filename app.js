document.addEventListener('DOMContentLoaded', () => {
    ...
    (function(index){
        squares[i].onclick = function(){
            // Check if square below clicked square is taken and check if clicked square isn't taken
